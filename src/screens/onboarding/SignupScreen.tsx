...
export function SignupScreen({ navigation }: Props) {
  ...
  return (
    <FadeHeroScreen source={whiteWaterWavesImage}>
      <ScreenHeader onBack={() => navigation.navigate('QuizBudget', {})} />
      <Content>
        <TextCloud>
          <Title>Create your account</Title>
          <Subtitle>Save your skin profile!</Subtitle>
        </TextCloud>
        <FieldGroup>
        ...
        <Spacer />
        <PrimaryButton label="Create Account" disabled={!fieldsValid} onPress={handleCreateAccount} />
        <LinkBubble>
          <TextLink
